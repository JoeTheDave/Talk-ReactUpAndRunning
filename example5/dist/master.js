...
var _SubComponent = require('./SubComponent');

var _SubComponent2 = _interopRequireDefault(_SubComponent);

var TopLevelComponent = (function (_React$Component) {
    _inherits(TopLevelComponent, _React$Component);

    function TopLevelComponent(props) {
        _classCallCheck(this, TopLevelComponent);

        _get(Object.getPrototypeOf(TopLevelComponent.prototype), 'constructor', this).call(this, props);
    ...
    _createClass(TopLevelComponent, [{
        key: 'increment',
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_SubComponent2['default'], { handler: this.increment, text: "increment" }),
                _react2['default'].createElement(_SubComponent2['default'], { handler: this.decrement, text: "decrement" })
            );
        }
    }]);
...
exports['default'] = TopLevelComponent;
module.exports = exports['default'];


},{"./SubComponent":159,"react":158}],161:[function(require,module,exports){
...
var _componentsTopLevelComponent = require('./components/TopLevelComponent');

var _componentsTopLevelComponent2 = _interopRequireDefault(_componentsTopLevelComponent);

(0, _reactDom.render)(_react2['default'].createElement(_componentsTopLevelComponent2['default'], null), document.getElementById('app'));


},{"./components/TopLevelComponent":160,"react":158,"react-dom":2}]},{},[161]);
