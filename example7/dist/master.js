...
},{"dup":1,"react/lib/ReactDOM":38}],4:[function(require,module,exports){
/**
...
var _SquareFader = require('./SquareFader');

var _SquareFader2 = _interopRequireDefault(_SquareFader);
    ...
    _createClass(ApplicationComponent, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_SquareFader2['default'], { visible: this.state.visible })
            );
        }
    }]);
...
},{"./SquareFader":161,"react":159}],161:[function(require,module,exports){
...
var SquareFader = (function (_React$Component) {
    _inherits(SquareFader, _React$Component);

    function SquareFader(props) {
        _classCallCheck(this, SquareFader);

        _get(Object.getPrototypeOf(SquareFader.prototype), 'constructor', this).call(this, props);
    }

    _createClass(SquareFader, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(nextProps) {
            if (nextProps.visible !== this.props.visible) {
                if (nextProps.visible) {
                    $((0, _ReactDom.findDOMNode)(this)).stop(true, true).fadeIn('slow');
                } else {
                    $((0, _ReactDom.findDOMNode)(this)).stop(true, true).fadeOut('slow');
                }
            }
        }
    }, {
...
exports['default'] = SquareFader;
module.exports = exports['default'];


},{"React-dom":1,"react":159}],162:[function(require,module,exports){
...
var _componentsApplicationComponent = require('./components/ApplicationComponent');

var _componentsApplicationComponent2 = _interopRequireDefault(_componentsApplicationComponent);
...
},{"./components/ApplicationComponent":160,"react":159,"react-dom":3}]},{},[162]);
